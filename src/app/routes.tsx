...
const routes: AppRouteConfig[] = [
  {
    ...
    label: 'Dashboard',
    path: '/',
    title: 'Quarkus Coffeeshop | Main Dashboard',
  },
  {
    ...
    title: 'Quarkus Coffeeshop | System Components',
  },
  {
    component: Support,
    exact: true,
    ...
    label: 'Support',
    path: '/support',
    title: 'Quarkus Coffeeshop | Support Page',
  },
  {
    label: 'Settings',
    routes: [
      {
        ...
        title: 'Quarkus Coffeeshop | General Settings',
      },
      {
        ...
        title: 'Quarkus Coffeeshop | Profile Settings',
      },
    ],
  },
];
